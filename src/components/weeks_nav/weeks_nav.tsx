...
const Weeks_nav = () => {
    return (
        <div className="border rounded d-flex justify-content-between align-items-center px-2 my-3">
            <button>
            ...
            <p id="date" className="fs-5 mt-1">01.02.2024-07.02.2024</p>
            <button>
